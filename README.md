...
- ドローン関連システム開発 (飛行日誌管理、壁面点検)
- 医学会向け会員管理システム開発 (3万人規模のメール配信機能, 複数の資格申請機能)
- ホテル予約管理システムと iOS チェックインアプリの開発・運用・保守
- 3D 地形可視化アプリ開発 (Cesium.js使用、災害シミュレーション機能付き)
